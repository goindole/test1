...
//		out.println("<h1>" + message + "</h1>");
		...
		String newMessage=request.getParameter("message");//gets the message submitted by the url and stores in variable
		request.setAttribute("msgNew", newMessage);//assigns message to a Key for showing in the html
	...
	public String CheckPost(String someValue)
	{
		String custMsg="I'm sorry I dont know you";
	
		if(someValue.equals("John"))
		{
			custMsg="nice to see John keep working hard";	
		}
		
		else if(someValue.equals("Thomas"))
		{
